...
setup(
    ...
    download_url=f'https://github.com/cshaley/bracketeer/archive/{bracketeer.__version__}.tar.gz',
    packages=find_packages(),
    package_data={'bracketeer': ['bracketeer/empty_brackets/*.jpg'], 'tests': ['tests/input/*.csv']},
